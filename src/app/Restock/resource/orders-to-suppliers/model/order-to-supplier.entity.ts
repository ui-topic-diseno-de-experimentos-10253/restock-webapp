...
export class OrderToSupplier {
  ...
  constructor(data: Partial<OrderToSupplier> = {}) {
    ...
    this.estimated_ship_date = data.estimated_ship_date ? new Date(data.estimated_ship_date) : null;
    this.estimated_ship_time = data.estimated_ship_time ? new Date(data.estimated_ship_time) : null;
